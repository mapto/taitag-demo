package it.unimi.di.islab.taitag.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, it.unimi.di.islab.taitag.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, it.unimi.di.islab.taitag.repository.UserRepository.USERS_BY_EMAIL_CACHE);
